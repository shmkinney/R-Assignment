...
```{r, echo=FALSE}
ggplot(cmchr1) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr2) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr3) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr4) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr5) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr6) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr7) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr8) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr9) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```

```{r, echo=FALSE}
ggplot(cmchr10) + geom_bar(mapping = aes(x=Position.Binned, fill=Centromere)) + xlab("Area on Chromosome") + ylab("SNP Density")
```
