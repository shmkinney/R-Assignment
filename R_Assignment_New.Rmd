...
```
```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=Homozygous, fill=Group))
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=Homozygous, fill=Group), position = "fill")
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_density(mapping = aes(x=Homozygous, fill=Group), alpha=0.4)
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_density(mapping = aes(x=Homozygous, fill=Category), alpha=0.4)
```
...
```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=Heterozygous, fill=Group))
```
```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=Heterozygous, fill=Group),position = "fill")
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_density(mapping = aes(x=Heterozygous, fill=Group), alpha=0.4)
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_density(mapping = aes(x=Heterozygous, fill=Category), alpha=0.4)
```
...
```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=MissingData, fill=Group))
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=MissingData, fill=Group), position = "fill")
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=MissingData, fill=Category))
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_bar(mapping = aes(x=MissingData, fill=Category), position = "fill")
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_density(mapping = aes(x=MissingData, fill=Group), alpha=0.4)
```

```{r, echo = FALSE}
ggplot(HetFull) + geom_density(mapping = aes(x=MissingData, fill=Category), alpha=0.4)
```
...
ggplot(newmt) + geom_bar(mapping = aes(x=Group, fill = snp_data), position = "fill")

ggplot(newmt) + geom_bar(mapping= aes(x=Category, fill = snp_data), position = "fill")

ggplot(newmt) + geom_bar(mapping = aes(x=Sample_ID, fill = snp_data), position = "fill")
